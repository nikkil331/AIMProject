...
class StaticSyncBlockTest(unittest.TestCase):
    ...
    def test_syncOn_class(self):
        ...
        runRR = shlex.split("rrrun -classpath=\"src/Targets\" -toolpath=\"classes/tools/trials\" -classes=\"-SyncBlocksStats.*\" -tool=SyncBlocksStats StaticSyncBlockTests.StaticSBT13")
        runner = subprocess.Popen(runRR, stdout=subprocess.PIPE)
    ...
    def test_simple_final(self):
        ...
        runRR = shlex.split("rrrun -array=FINE -classpath=\"src/Targets\" -toolpath=\"classes/tools/trials\" -classes=\"-SyncBlocksStats.*\" -tool=SyncBlocksStats SyncBlockTest38")
        runner = subprocess.Popen(runRR, stdout=subprocess.PIPE)
    ...
    def test_methodCall_syncedClass(self):
        ...
        runRR = shlex.split("rrrun -array=FINE -classpath=\"src/Targets\" -toolpath=\"classes/tools/trials\" -classes=\"-SyncBlocksStats.*\" -tool=SyncBlocksStats SyncBlockTest39")
        runner = subprocess.Popen(runRR, stdout=subprocess.PIPE)
    ...
    def test_oneMethodCall(self):
        ...
        runRR = shlex.split("rrrun -array=FINE -classpath=\"src/Targets\" -toolpath=\"classes/tools/trials\" -classes=\"-SyncBlocksStats.*\" -tool=SyncBlocksStats SyncBlockTest41")
        runner = subprocess.Popen(runRR, stdout=subprocess.PIPE)
...
#        runRR = shlex.split("rrrun -array=FINE -classpath=\"src/Targets\" -toolpath=\"classes/tools/trials\" -classes=\"-SyncBlocksStats.*\" -tool=SyncBlocksStats SyncBlockTest42")
#        runner = subprocess.Popen(runRR, stdout=subprocess.PIPE)
...
#        self.assertEqual(resultList['SyncBlockTest42.java line 6']['depths'], [0]);
    ...
    def test_interfaceInheritance(self):
        ...
        runRR = shlex.split("rrrun -array=FINE -classpath=\"src/Targets\" -toolpath=\"classes/tools/trials\" -classes=\"-SyncBlocksStats.*\" -tool=SyncBlocksStats SyncBlockTest44");
        runner = subprocess.Popen(runRR, stdout=subprocess.PIPE)
    ...
    def test_heirarchy(self):
        ...
        runRR = shlex.split("rrrun -array=FINE -classpath=\"src/Targets\" -toolpath=\"classes/tools/trials\" -classes=\"-SyncBlocksStats.*\" -tool=SyncBlocksStats SyncBlockTest47")
        runner = subprocess.Popen(runRR, stdout=subprocess.PIPE)
    ...
    def test_recursive_reentrant_readLast(self):
        ...
        runRR = shlex.split("rrrun -array=FINE -classpath=\"src/Targets\" -toolpath=\"classes/tools/trials\" -classes=\"-SyncBlocksStats.*\" -tool=SyncBlocksStats SyncBlockTest37")
        runner = subprocess.Popen(runRR, stdout=subprocess.PIPE)
    ...
    def test_mulitpleDepths(self):
        ...
        runRR = shlex.split("rrrun -array=FINE -classpath=\"src/Targets\" -toolpath=\"classes/tools/trials\" -classes=\"-SyncBlocksStats.*\" -tool=SyncBlocksStats SyncBlockTest40")
        runner = subprocess.Popen(runRR, stdout=subprocess.PIPE)
    ...
    def test_rnw_diffDepths(self):
        ...
        runRR = shlex.split("rrrun -array=FINE -classpath=\"src/Targets\" -toolpath=\"classes/tools/trials\" -classes=\"-SyncBlocksStats.*\" -tool=SyncBlocksStats SyncBlockTest43")
        runner = subprocess.Popen(runRR, stdout=subprocess.PIPE)
