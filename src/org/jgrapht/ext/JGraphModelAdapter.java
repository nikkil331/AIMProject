    ...
    extends DefaultGraphModel
{
     ...
     */
    public final Map<org.jgraph.graph.Edge, E> cellToEdge =
        new HashMap<org.jgraph.graph.Edge, E>();

    /**
     * Maps JGraph vertices to JGraphT vertices
     */
    public final Map<GraphCell, V> cellToVertex = new HashMap<GraphCell, V>();
        ...
        CellFactory<V, E> cellFactory)
    {
       ...
       /* if ((jGraphTGraph == null)
        ...
        if(jGraphTGraph == null){
        	throw new IllegalArgumentException("null graph is NOT permitted");
        }
        else if (defaultVertexAttributes == null){
        	throw new IllegalArgumentException("null vertex attributes is NOT permitted");
        }
        else if(defaultEdgeAttributes == null){
        	throw new IllegalArgumentException("null edge attributes is NOT permitted");
        }
        else if(cellFactory == null){
        	throw new IllegalArgumentException("null cellFactory is NOT permitted");
        }
    ...
    @SuppressWarnings("unchecked")
    protected AttributeMap createEdgeAttributeMap(DefaultEdge edgeCell)
    {
